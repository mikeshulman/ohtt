...
-- This should be provable from a corresponding postulate for sym-ap.
postulate
  SYM-AP : {Γ Δ : Tel} (f : el Γ → el Δ) (γ : el (SQ Γ)) →
    AP (AP f) (SYM Γ γ) ≡ SYM Δ (AP (AP f) γ)
-- SYM-AP f γ = {!!}

postulate
  -- This should be admissible by induction over concrete types
