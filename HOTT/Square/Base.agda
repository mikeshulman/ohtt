...
top₀₀ : {Δ : Tel} {A : el Δ → Type} (δ : el (SQ (Δ ▸ A))) → A (popsq {Δ} {A} δ ₀₀)
...
top₁₂ : {Δ : Tel} {A : el Δ → Type} (δ : el (SQ (Δ ▸ A))) →
  Id₁₂ A (popsq {Δ} {A} δ) {top₀₀ {Δ} {A} δ} {top₀₁ {Δ} {A} δ} (top₀₂ {Δ} {A} δ)
       (top₁₀ {Δ} {A} δ) (top₁₁ {Δ} {A} δ)
top₁₂ (δ ∷ a₀₀ ∷ a₀₁ ∷ a₀₂ ∷ a₁₀ ∷ a₁₁ ∷ a₁₂ ∷ a₂₀ ∷ a₂₁ ∷ a₂₂) = a₁₂
...
postulate
  sq∷₀₂ : {Δ : Tel} (A : el Δ → Type) (δ : el (SQ Δ))
    ...
    (a₂₀ : Id A (δ ₂₀) a₀₀ a₁₀) (a₂₁ : Id A (δ ₂₁) a₀₁ a₁₁)
    (a₂₂ : Sq A δ a₀₂ a₁₂ a₂₀ a₂₁) →
    AP (_₀ {Δ ▸ A}) (δ ∷ a₀₀ ∷ a₀₁ ∷ a₀₂ ∷ a₁₀ ∷ a₁₁ ∷ a₁₂ ∷ a₂₀ ∷ a₂₁ ∷ a₂₂) ≡ᵉ δ ₀₂ ∷ a₀₀ ∷ a₀₁ ∷ a₀₂
  sq∷₁₂ : {Δ : Tel} (A : el Δ → Type) (δ : el (SQ Δ))
    {a₀₀ : A (δ ₀₀)} {a₀₁ : A (δ ₀₁)} (a₀₂ : Id₀₂ A δ a₀₀ a₀₁)
    {a₁₀ : A (δ ₁₀)} {a₁₁ : A (δ ₁₁)} (a₁₂ : Id₁₂ A δ a₀₂ a₁₀ a₁₁)
    (a₂₀ : Id A (δ ₂₀) a₀₀ a₁₀) (a₂₁ : Id A (δ ₂₁) a₀₁ a₁₁)
    (a₂₂ : Sq A δ a₀₂ a₁₂ a₂₀ a₂₁) →
    AP (_₁ {Δ ▸ A}) (δ ∷ a₀₀ ∷ a₀₁ ∷ a₀₂ ∷ a₁₀ ∷ a₁₁ ∷ a₁₂ ∷ a₂₀ ∷ a₂₁ ∷ a₂₂) ≡ᵉ
