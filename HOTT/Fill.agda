...
fill→ {Δ} A δ {a₀₀} {a₀₁} a₀₂ {a₁₀} {a₁₁} a₁₂ a₂₀ =
  lift→ {ID▸▸ Δ} (Id/ A) (δ ∷ a₀₀ ∷ a₀₁ ∷ a₀₂ ∷ a₁₀ ∷ a₁₁ ∷ a₁₂) a₂₀
...
fill← {Δ} A δ {a₀₀} {a₀₁} a₀₂ {a₁₀} {a₁₁} a₁₂ a₂₁ =
  lift← {ID▸▸ A} (Id/ A) (δ ∷ a₀₀ ∷ a₀₁ ∷ a₀₂ ∷ a₁₀ ∷ a₁₁ ∷ a₁₂) a₂₁
...
fill↑ {Δ} A δ {a₀₀} {a₀₁} a₀₂ {a₁₀} {a₁₁} a₂₀ a₂₁ =
  sym A (SYM Δ δ) {a₀₀} {a₁₀} a₂₀ {a₀₁} {a₁₁} a₂₁ a₀₂
    (comp→ A (SYM Δ δ) a₂₀ a₂₁ a₀₂) (fill→ A (SYM Δ δ) a₂₀ a₂₁ a₀₂)
...
fill↓ {Δ} A δ {a₀₀} {a₀₁} {a₁₀} {a₁₁} a₁₂ a₂₀ a₂₁ =
  sym A (SYM Δ δ) {a₀₀} {a₁₀} a₂₀ {a₀₁} {a₁₁} a₂₁
    (comp← A (SYM Δ δ) a₂₀ a₂₁ a₁₂) a₁₂ (fill← A (SYM Δ δ) a₂₀ a₂₁ a₁₂)
...
fill-ulift→ : {Δ : Tel} (A : Δ ⇨ Type) (δ : el (ID Δ)) (a₀ : A ⊘ (δ ₀))
    ...
    Id {ε ▸ (Λ _ ⇨ A ⊘ (δ ₁))} (Λ w ⇨ Id A δ a₀ (top w))
      ([] ∷ a₁ ∷ a₁' ∷ fill-utr→ A δ a₀ a₁ a₁' a₂ a₂') a₂ a₂'
